...
2. Decompress and put `cc.en.300.bin` inside `fastText`directory
...
2. Decompress and put `en_vectors_web_lg-2.1.0` (most inner folder) under `spacy_glove` directory

### Universal Sentence Encoder
1. Download the [ransformer variant of Universal Sentence Encoder](https://tfhub.dev/google/universal-sentence-encoder-large/3) [[direct link](https://tfhub.dev/google/universal-sentence-encoder-large/3?tf-hub-format=compressed)]
